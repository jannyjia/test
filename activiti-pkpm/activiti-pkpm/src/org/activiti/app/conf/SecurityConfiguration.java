	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http
	            ...
	            .authorizeRequests()
	                ...
	                .antMatchers("/app/rest/process-instances/**").permitAll()
	                ...
	                .antMatchers("/app/rest/designer/*").permitAll()
	                .antMatchers("/app/rest/autologin/**").permitAll()
	                //.antMatchers("/app/rest/api/**").permitAll()
	        ...
	        http.apply(httpSecurityLogoutConfigurer);
	    }
	...
	public static class ApiWebSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {
			...
			http
				...
				.antMatcher("/swagger-resources/configuration/ui")
				.antMatcher("/swagger-resources")
				.antMatcher("/swagger-resources/configuration/security")
				.antMatcher("/swagger-resources/**")
				.authorizeRequests()
