...
public class StencilSetResource {
  ...
  public JsonNode getStencilSetForEditor() {
    try {
      String jsonData = IOUtils.toString(this.getClass().getClassLoader().getResourceAsStream("stencilset_bpmn.json"));
      JsonNode stencilNode = objectMapper.readTree(jsonData.getBytes("utf-8"));
      return stencilNode;
    } catch (Exception e) {
