...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  */
  ...
  public void initDataManagers() {
	  org.springframework.core.env.Environment environment = ApplicationContextRegister.getApplicationContext().getBean(org.springframework.core.env.Environment.class);
    ...
    if (groupDataManager == null) {
    	switch(environment.getRequiredProperty("api.userGroupType")) {
    		case "SSO":
    			groupDataManager = new SSOGroupDataManager(this);
    			break;
    		case "View":
    			groupDataManager = new ViewGroupDataManager(this);
    			break;
    		default:
    ...
    if (userDataManager == null) {
    	switch(environment.getRequiredProperty("api.userGroupType")) {
		case "SSO":
			userDataManager = new SSOUserDataManager(this);
			break;
		case "View":
			userDataManager = new ViewUserDataManager(this);
			break;
		default:
