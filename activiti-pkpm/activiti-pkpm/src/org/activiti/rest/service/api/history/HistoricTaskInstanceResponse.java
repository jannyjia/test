...
public class HistoricTaskInstanceResponse {
  ...
  protected String processInstanceStartUser;
  @JsonSerialize(using = DateToStringSerializer.class, as = Date.class)
  protected Date processInstanceStartTime;
  @JsonSerialize(using = DateToStringSerializer.class, as = Date.class)
  protected Date processInstanceEndTime;
  ...
  public String getCategory() {
	...
	public String getProcessInstanceStartUser() {
		return processInstanceStartUser;
	}
	
	public void setProcessInstanceStartUser(String processInstanceStartUser) {
		this.processInstanceStartUser = processInstanceStartUser;
	}
