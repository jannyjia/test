  ...
  // Initialize routes
   ...
   $provide.value('appResourceRoot', appResourceRoot);
    ...
    $routeProvider
        ...
        .when('/pdm/showDiagramByProcessId/:processId', {
        	templateUrl: appResourceRoot + 'views/show-diagram.html',
        	controller: 'ProcessController'
        })
        .when('/pdm/listOperateHistory/:quotedQueryParam', {
        	templateUrl: appResourceRoot + 'views/list-operate-history.html',
        	controller: 'ListOperateHistoryController',
        	resolve: {
        		verify: authRouteResolver
        	}
        })
